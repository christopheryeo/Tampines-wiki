...
PRODUCTION_DATABASE = "MSM_dataset"
...
def _mysql_command(database: str = TARGET_DATABASE) -> tuple[list[str], dict[str, str]]:
    ...
    command = [
        ...
        # Current full-wiki transaction procedures can exceed the mysql
        # client's conservative default packet size even though each row and
        # every deterministic insert chunk is schema-valid.
