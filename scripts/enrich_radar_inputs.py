...
from tag_registry import TAG_ROOT, active_inventory  # noqa: E402
...
def load_tag_inventory() -> list[tuple[str, str, int]]:
    """Return the enrichment inventory from active Markdown Tag entities."""

    rows = active_inventory(TAG_ROOT)
    if not rows:
