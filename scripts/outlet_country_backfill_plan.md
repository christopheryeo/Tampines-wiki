...
the 2026-08-27 query on foreign coverage of Singapore defence did. Lint cannot check `country`
...
- `scripts/loose_article_ingest_plan.md` — where Phase 5's intake change lands
