...
def main() -> int:
    ...
    if args.sentiment_adjudication and set(sentiment_decisions) != sentiment_holds:
    ...
    if args.tone_adjudication and set(tone_decisions) != tone_holds:
    ...
    if args.metadata_adjudication and set(metadata_decisions) != metadata_holds:
    ...
    if args.event_adjudication and set(event_decisions) != event_holds:
